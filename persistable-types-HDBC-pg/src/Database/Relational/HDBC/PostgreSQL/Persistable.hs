...
-- |
-- Module      : Database.Relational.HDBC.PostgreSQL.Persistable
...
module Database.Relational.HDBC.PostgreSQL.Persistable () where
...
import Database.Relational.HDBC.PostgreSQL.Instances ()
