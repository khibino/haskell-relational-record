...
import Database.Record.KeyConstraint
  (HasSingleKeyConstraint(keyConstraint), SingleKeyConstraint, NotNull, index)
...
instance (HasSingleKeyConstraint NotNull a, FromSql q a, PersistableType q)
